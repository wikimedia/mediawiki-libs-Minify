 ...
 *
 * This class was written with ECMA-262 9th Edition in mind ("ECMAScript 2018"). Parsing features
...
class JavaScriptMinifier {
	...
	private static $opChars = [
		// ECMAScript 9.0 § 11.7 Punctuators
		//
		//    Punctuator
		//    DivPunctuator
		...
		// ECMAScript 9.0 § 11.8.4 String Literals
		'"' => true,
		"'" => true,

		// ECMAScript 9.0 § 11.8.6 Template Literal Lexical Components
		'`' => true,
	];
	...
	private static $tokenTypes = [
		// ECMAScript 9.0 § 12.2 Primary Expression
		//
		//    ...BindingIdentifier
		//
		'...'        => self::TYPE_UN_OP,

		// ECMAScript 9.0 § 12.3 Left-Hand-Side Expressions
		//
		//    MemberExpression
		//
		...
		// ECMAScript 9.0 § 12.4 Update Expressions
		//
		...
		// ECMAScript 9.0 § 12.5 Unary Operators
		//
		//    UnaryExpression
		...
		//     - UnaryExpression
		//
		// ECMAScript 9.0 § 12.8 Additive Operators
		//
		...
		//
		// Defined in:
		// - ECMAScript 9.0 § 12.6 Exponentiation Operator
		//   ExponentiationExpression
		// - ECMAScript 9.0 § 12.7 Multiplicative Operators
		//   MultiplicativeOperator
		// - ECMAScript 9.0 § 12.9 Bitwise Shift Operators
		//   ShiftExpression
		// - ECMAScript 9.0 § 12.10 Relational Operators
		//   RelationalExpression
		// - ECMAScript 9.0 § 12.11 Equality Operators
		//   EqualityExpression
		'**'         => self::TYPE_BIN_OP,
		'*'          => self::TYPE_BIN_OP,
		'/'          => self::TYPE_BIN_OP,
		...
		// ECMAScript 9.0 § 12.12 Binary Bitwise Operators
		//
		...
		// ECMAScript 9.0 § 12.13 Binary Logical Operators
		//
		...
		// ECMAScript 9.0 § 12.14 Conditional Operator
		//
		...
		// ECMAScript 9.0 § 12.15 Assignment Operators
		'='          => self::TYPE_BIN_OP,
		'*='         => self::TYPE_BIN_OP,
		'/='         => self::TYPE_BIN_OP,
		'%='         => self::TYPE_BIN_OP,
		...
		// ECMAScript 9.0 § 12.16 Comma Operator
		','          => self::TYPE_COMMA,

		// ECMAScript 9.0 § 11.9.1 Rules of Automatic Semicolon Insertion
		//
		...
		// ECMAScript 9.0 § 13.7.5 The for-of Statement
		'of'         => self::TYPE_BIN_OP,
		...
		// ECMAScript 9.0 § 13.3 Declarations and the Variable Statement
		//
		//    LetOrConst
		//    VariableStatement
		//
		...
		// ECMAScript 9.0 § 14.1 Function Definitions
		'function'   => self::TYPE_FUNC,

		// ECMAScript 9.0 § 14.2 Arrow Function Definitions
		'=>'         => self::TYPE_ARROW,

		// ECMAScript 9.0 § 14.6 Class Definitions
		//
		...
		// ECMAScript 9.0 § 14.7 Async Function Definitions
		//
		//     AwaitExpression:
		...
		// Can be one of:
		// - Block (ECMAScript 9.0 § 13.2 Block)
		// - ObjectLiteral (ECMAScript 9.0 § 12.2 Primary Expression)
		...
		// - PrimaryExpression (ECMAScript 9.0 § 12.2 Primary Expression)
		// - CallExpression (ECMAScript 9.0 § 12.3 Left-Hand-Side Expressions)
		// - Beginning of an ArrowFunction (ECMAScript 9.0 § 14.2 Arrow Function Definitions)
		'('          => self::TYPE_PAREN_OPEN,
		')'          => self::TYPE_PAREN_CLOSE,

		// Can be one of:
		// - ArrayLiteral (ECMAScript 9.0 § 12.2 Primary Expressions)
		// - ComputedPropertyName (ECMAScript 9.0 § 12.2.6 Object Initializer)
		'['          => self::TYPE_PAREN_OPEN,
		']'          => self::TYPE_PAREN_CLOSE,

		// Can be one of:
		// - End of any statement
		// - EmptyStatement (ECMAScript 9.0 § 13.4 Empty Statement)
		';'          => self::TYPE_SEMICOLON,
